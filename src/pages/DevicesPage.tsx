...
export const DevicesPage: React.FC<DevicesPageProps> = ({ onNavigateToDetail, initialFeederId }) => {
  ...
  // Realtime debounce check for DEVICE_ID uniqueness
