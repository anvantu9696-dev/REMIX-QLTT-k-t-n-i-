...
const newCode = `// In-memory caching and Firebase monitoring logger
...
fs.writeFileSync('server/utils/firestoreCache.ts', newCode);
console.log('Fixed firestoreCache race condition');
